...
use App\Http\Requests\RegistroF10_3;
use DB;
use Maatwebsite\Excel\Facades\Excel;
use App\Exports\F10_3Export;
use Illuminate\Support\Collection;

class F10_3Controller extends Controller
{
    ...
    public function index(Request $request){
    	if($request){
            ...
            $registro=DB::table('form_010_3s as fo')->where('fo.gestion','LIKE','%'.$query.'%')
            ->orderBy('fo.idf10_3','asc')
            ->paginate(8);
          return view('DAF.form_010_3.index',["registro"=>$registro,"searchText"=>$query]);
    	}
    }
    public function create(){
    	return view('DAF.form_010_3.create');

    }
    public function store(RegistroF10_3 $request)
    {
           $registros = new Form_010_3;
        ...
        return Redirect:: to('DAF/form_010_3');
    }
    ...
    {
         $registro=DB::table('form_010_3s')->where('idf10_3','=',$id)->delete();
    return Redirect::to('DAF/form_010_3');
    }
    ...
    public function exportar(Request $request){
       ...
       // $excel=Excel::download(new F4_2Export(), 'f4_2.xlsx'["searchText"=>$query]);
        //return $excel;
        return Excel::download(new F10_3Export, 'f10_3.xlsx');
    }
}
