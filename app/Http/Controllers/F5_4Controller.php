...
class F5_4Controller extends Controller
{
    ...
    public function index(Request $request){
    	if($request){
            ...
            $registro=DB::table('form_005_4s as fo')->where('fo.gestion','LIKE','%'.$query.'%')
            ->orderBy('fo.idf5_4','asc')
            ->paginate(4);
          return view('Bibliotecas.form_005_4.index',["registro"=>$registro,"searchText"=>$query]);
    	}
    }
    public function create(){
    	return view('Bibliotecas.form_005_4.create');

    }
    public function store(RegistroF5_4 $request)
    {
           $registros = new Form_005_4;
        ...
        return Redirect:: to('Bibliotecas/form_005_4');
    }
    ...
    {
         $registro=DB::table('form_005_4s')->where('idf5_4','=',$id)->delete();
    return Redirect::to('Bibliotecas/form_005_4');
    }
    ...
    public function exportar(Request $request){
       ...
       // $excel=Excel::download(new F4_2Export(), 'f4_2.xlsx'["searchText"=>$query]);
        //return $excel;
        return Excel::download(new F5_4Export, 'f5_4.xlsx');
    }
}
