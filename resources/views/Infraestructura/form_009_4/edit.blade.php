...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<h3>Editar registro: {{$registro->obras}} <a href="{{Route('Infraestructura.form_009_4.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
		@if(count($errors)>0)
		...
		{!!Form::model($registro,['method'=>'PATCH','route'=>['Infraestructura.form_009_4.update',$registro->idf9_4]])!!}
        {{Form::token()}}

		<div class="form-group">
			<label for="obras">OBRAS EN PROCESO DE CONTRATACION</label>
