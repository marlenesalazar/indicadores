...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h3>Nuevo registro <a href="{{route('BienestarUniversitario.form_004_5.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
...
{!!Form::open(array('url'=>'BienestarUniversitario/form_004_5','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <table id="detalle" class="table table-striped table-bordered table-condensed table-hover text-center">
        <h4 align="center">BENEFICIAROS CON BECA ALIMENTACION POR TIPO DE BECA, SEGUN SEXO Y CARRERAS</h4>
