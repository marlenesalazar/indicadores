...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h3>Nuevo registro <a href="{{route('BienestarUniversitario.form_004_10.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
...
{!!Form::open(array('url'=>'BienestarUniversitario/form_004_10','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
<div class="row">
...
<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
    <div class="form-group">
        ...
        <input type="number" name="ptitular" id="ptitular" class="form-control" placeholder="cantidad">
    </div>
</div>
<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
    <div class="form-group">
        <label for="invitado">INVITADO</label>
        <input type="number" name="pinvitado" id="pinvitado" class="form-control" placeholder="cantidad">
    </div>
</div>
<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
    <div class="form-group">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <table id="detalle" class="table table-striped table-bordered table-condensed table-hover text-center">
        <h4 align="center">AUXILIARES DE DOCENCIA SEGUN CARRERAS Y TIPO DE BECA</h4>
