...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<h3>Nuevo registro <a href="{{route('DireccionRelaciones.form_017_5.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
		@if(count($errors)>0)
		...
		@endif
		{!!Form::open(array('url'=>'DireccionRelaciones/form_017_5','method'=>'POST','autocomplete'=>'off'))!!}
        {{Form::token()}}
