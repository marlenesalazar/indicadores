...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h3>Nuevo registro <a href="{{route('titulos.form_002_3.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
...
{!!Form::open(array('url'=>'titulos/form_002_3','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
<div class="row">
