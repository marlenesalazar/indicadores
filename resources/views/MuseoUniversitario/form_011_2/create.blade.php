...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h3>Nuevo registro <a href="{{route('MuseoUniversitario.form_011_2.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
...
{!!Form::open(array('url'=>'MuseoUniversitario/form_011_2','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
<div class="row">
...
<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
    <div class="form-group">
        ...
        <input type="number" name="pmasculino" id="pmasculino" class="form-control" placeholder="cantidad">
    </div>
</div>
<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
    <div class="form-group">
        <label for="femenino">FEMENINO</label>
        <input type="number" name="pfemenino" id="pfemenino" class="form-control" placeholder="cantidad">
    </div>
</div>
<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
    <div class="form-group">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <table id="detalle" class="table table-striped table-bordered table-condensed table-hover text-center">
        <h4 align="center">VISITANTES AL MUSEO UNIVERSITARIO SEGUN CARRERAS Y SEXO</h4>
