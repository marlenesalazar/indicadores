...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h3>Nuevo registro <a href="{{route('JefaturaDePersonal.form_001_12.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
...
{!!Form::open(array('url'=>'JefaturaDePersonal/form_001_12','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
        ...
        <div class="panel-body">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="pcontrato" class="form-control selectpicker" id="pcontrato" data-live-search="true">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <table id="detalle" class="table table-striped table-bordered table-condensed table-hover text-center">
        <h4 align="center">PERSONAL ADMINISTRATIVO SEGUN NIVEL ACADEMICO Y TIPO DE CONTRATO</h4>
...
<script >
    ...
    function agregar(){
        ...
        if (contrato!="" && msc!="" && esp!="" && dip!="" && lic!="" && egr!="" && ts!="" && prof!="" && tm!="" && es!="" && emp!="" && obr!="" && total!="" && gestion!=""){
         var fila='<tr class="selected id="fila'+cont+'><td><a href="#" class="btn btn-danger remove"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg></a></td><td><input type="hiden" name="contrato[]" value="'+contrato+'"></td><td><input type="number" name="msc[]" value="'+msc+'"></td><td><input type="number" name="esp[]" value="'+esp+'"></td><td><input type="number" name="dip[]" value="'+dip+'"></td><td><input type="number" name="lic[]" value="'+lic+'"></td><td><input type="number" name="egr[]" value="'+egr+'"></td><td><input type="number" name="ts[]" value="'+ts+'"></td><td><input type="number" name="prof[]" value="'+prof+'"></td><td><input type="number" name="tm[]" value="'+tm+'"></td><td><input type="number" name="es[]" value="'+es+'"></td><td><input type="number" name="emp[]" value="'+emp+'"></td><td><input type="number" name="obr[]" value="'+obr+'"></td><td><input type="number" name="total[]" value="'+total+'"></td><td><input type="text" name="gestion[]" value="'+gestion+'"></td></tr>';
         cont++;
         limpiar();
         $('#detalle').append(fila); 
        }
