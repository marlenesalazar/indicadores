...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h3>Nuevo registro <a href="{{route('Bibliotecas.form_005_9.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
...
{!!Form::open(array('url'=>'Bibliotecas/form_005_9','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <table id="detalle" class="table table-striped table-bordered table-condensed table-hover text-center">
        <h4 align="center">OBRAS CONSULTADAS DE BIBLIOTECA DE GEOLOGIA</h4>
        <thead style="background-color: #A9D0F5">
            <tr>
               <th rowspan="4">OPCIONES</th>
               <th rowspan="4">USUARIO</th>
               <th colspan="4">GROLOGIA</th>
