...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<h3>Editar registro: {{$registro->año}} <a href="{{Route('DAF.form_010_9.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
		@if(count($errors)>0)
		...
		{!!Form::model($registro,['method'=>'PATCH','route'=>['DAF.form_010_9.update',$registro->idf10_9]])!!}
        {{Form::token()}}
		...
		<div class="form-group">
			<label for="i_social">INTERACCION SOCIAL Y EXTENSION UNIVERSITARIA</label>
			<input type="text" name="i_social" class="form-control" value="{{$registro->i_social}}">
		</div>
		<div class="form-group">
