...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<h3>Editar registro: {{$registro->año}} <a href="{{Route('DAF.form_010_6.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
		@if(count($errors)>0)
		...
		{!!Form::model($registro,['method'=>'PATCH','route'=>['DAF.form_010_6.update',$registro->idf10_6]])!!}
        {{Form::token()}}
		...
		<div class="form-group">
			<label for="construcciones">CONSTRUCCIONES</label>
			<input type="text" name="construcciones" class="form-control" value="{{$registro->construcciones}}">
		</div>
		<div class="form-group">
