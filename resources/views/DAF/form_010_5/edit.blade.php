...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<h3>Editar registro: {{$registro->año}} <a href="{{Route('DAF.form_010_5.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
		@if(count($errors)>0)
		...
		{!!Form::model($registro,['method'=>'PATCH','route'=>['DAF.form_010_5.update',$registro->idf10_5]])!!}
        {{Form::token()}}
		...
		<div class="form-group">
			...
			<input type="text" name="sueldos" class="form-control" value="{{$registro->sueldos}}">
		</div>
		<div class="form-group">
