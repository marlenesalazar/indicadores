...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<h3>Editar registro: {{$registro->año}} <a href="{{Route('DAF.form_010_8.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
		@if(count($errors)>0)
		...
		{!!Form::model($registro,['method'=>'PATCH','route'=>['DAF.form_010_8.update',$registro->idf10_8]])!!}
        {{Form::token()}}
		...
		<div class="form-group">
			<label for="c_personal">CAPACITACION DE PERSONAL</label>
			<input type="text" name="c_personal" class="form-control" value="{{$registro->c_personal}}">
		</div>
		<div class="form-group">
