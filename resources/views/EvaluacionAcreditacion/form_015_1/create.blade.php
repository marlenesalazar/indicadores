...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<h3>Nuevo registro <a href="{{route('EvaluacionAcreditacion.form_015_1.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
		@if(count($errors)>0)
		...
		@endif
		{!!Form::open(array('url'=>'EvaluacionAcreditacion/form_015_1','method'=>'POST','autocomplete'=>'off'))!!}
        {{Form::token()}}
		...
		<div class="form-group">
			...
			<input type="number" name="c_acreditadas" class="form-control" >
		</div>
		<div class="form-group">
