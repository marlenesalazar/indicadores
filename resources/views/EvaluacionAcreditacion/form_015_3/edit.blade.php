...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<h3>Editar registro: {{$registro->año}} <a href="{{Route('EvaluacionAcreditacion.form_015_3.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
		@if(count($errors)>0)
		...
		@endif
		{!!Form::model($registro,['method'=>'PATCH','route'=>['EvaluacionAcreditacion.form_015_3.update',$registro->idf15_3]])!!}
        {{Form::token()}}
		...
		<div class="form-group">
			...
			<input type="number" name="c_evaluacion" class="form-control" value="{{$registro->c_evaluacion}}">		
		</div>
		<div class="form-group">
