...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h3>Nuevo registro <a href="{{route('Extension.form_012_6.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
...
{!!Form::open(array('url'=>'Extension/form_012_6','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <div class="form-group">
        <label for="n_proyecto">NOMBRE DEL PROYECTO DE EXTENSION  (SEGUN OBJETIVO)</label>
        <input type="text" name="pn_proyecto" id="pn_proyecto" class="form-control">
    </div>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <div class="form-group">
        <label for="n_participantes">N° DE PARTICIPANTES_NOMBRESL</label>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <div class="form-group">
        ...
        <input type="number" name="presultados" id="presultados" class="form-control">
    </div>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <div class="form-group">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <table id="detalle" class="table table-striped table-bordered table-condensed table-hover text-center">
        <h4 align="center">EXTENSIONISTAS QUE PARTICIPAN EN EVENTOS NACIONALES</h4>
...
<script >
    ...
    function agregar(){
        ...
        if (id_c!="" && n_proyecto!="" && n_participantes!="" && e_tematico!="" && resultados!="" && gestion!=""){
         var fila='<tr class="selected id="fila'+cont+'><td><a href="#" class="btn btn-danger remove"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg></a></td><td><input type="hidden" name="id_c[]" value="'+id_c+'">'+nombre_c+'</td><td><input type="text" name="n_proyecto[]" value="'+n_proyecto+'"></td><td><input type="text" name="n_participantes[]" value="'+n_participantes+'"></td><td><input type="text" name="e_tematico[]" value="'+e_tematico+'"></td><td><input type="number" name="resultados[]" value="'+resultados+'"></td><td><input type="text" name="gestion[]" value="'+gestion+'"></td></tr>';
