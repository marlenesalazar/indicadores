...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h3>Nuevo registro <a href="{{route('DireccionDeInvestigacion.form_008_7.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
...
{!!Form::open(array('url'=>'DireccionDeInvestigacion/form_008_7','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <div class="form-group">
        <label for="revista">NOMBRE DE LA REVISTA INDEXADA</label>
        <input type="text" name="prevista" id="prevista" class="form-control">
    </div>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <div class="form-group">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <table id="detalle" class="table table-striped table-bordered table-condensed table-hover text-center">
        <h4 align="center">INVESTIGADORES QUE PUBLICAN ARTICULOS EN REVISTAS INDEXADAS</h4>
        <thead style="background-color: #A9D0F5">
            <tr>
               <th>OPCIONES</th>
               <th>CARRERAS</th>
               <th>NOMBRE DE LA REVISTA INDEXADA</th>
