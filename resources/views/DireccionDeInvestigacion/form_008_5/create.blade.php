...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h3>Nuevo registro <a href="{{route('DireccionDeInvestigacion.form_008_5.index')}}"><button class="btn btn-danger">Cancelar</button></a></h3>
...
{!!Form::open(array('url'=>'DireccionDeInvestigacion/form_008_5','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <div class="form-group">
        <label for="u_proponente">UNIDAD PROPONENTE</label>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <div class="form-group">
        ...
        <input type="text" name="pinvestigador" id="pinvestigador" class="form-control">
    </div>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <div class="form-group">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <table id="detalle" class="table table-striped table-bordered table-condensed table-hover text-center">
        <h4 align="center">PROYECTOS DE INVESTIGACION EJECUTADOS CON ENTIDADES PUBLICAS</h4>
...
<script >
    ...
    function agregar(){
        ...
        u_proponente=$("#pu_proponente").val();
        investigador=$("#pinvestigador").val();
        e_financiera=$("#pe_financiera").val();
        t_ejecucion=$("#pt_ejecucion").val();
        gestion=$("#pgestion").val();
        if (id_c!="" && proyecto!="" && e_tematico!="" && u_proponente!="" && investigador!="" && e_financiera!="" && t_ejecucion!=""&& gestion!=""){
         var fila='<tr class="selected id="fila'+cont+'><td><a href="#" class="btn btn-danger remove"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg></a></td><td><input type="hidden" name="id_c[]" value="'+id_c+'">'+nombre_c+'</td><td><input type="text" name="proyecto[]" value="'+proyecto+'"></td><td><input type="text" name="e_tematico[]" value="'+e_tematico+'"></td><td><input type="text" name="u_proponente[]" value="'+u_proponente+'"></td><td><input type="text" name="investigador[]" value="'+investigador+'"></td><td><input type="text" name="e_financiera[]" value="'+e_financiera+'"></td><td><input type="text" name="t_ejecucion[]" value="'+t_ejecucion+'"></td><td><input type="text" name="gestion[]" value="'+gestion+'"></td></tr>';
