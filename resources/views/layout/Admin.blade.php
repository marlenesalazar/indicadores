...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>IND</b>V</span>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('JefaturaDePersonal/form_001_1')}}"><i class="fa fa-circle-o"></i> Personal Docente Por Categoría, Dedicación Según Carga Horaria y Sexo</a></li>
                <!--<li><a href="{{url('JefaturaDePersonal/form_001_2')}}"><i class="fa fa-circle-o"></i>Personal Docente Según Facultad Y Sexo</a></li>-->
                <li><a href="{{url('JefaturaDePersonal/form_001_3')}}"><i class="fa fa-circle-o"></i>Personal Docente Por Sexo, Según Carreras</a></li>
                <li><a href="{{url('JefaturaDePersonal/form_001_4')}}"><i class="fa fa-circle-o"></i>Personal Docente Por Categoría Y Dedicación, Según Carreras</a></li>
                <li><a href="{{url('JefaturaDePersonal/form_001_5')}}"><i class="fa fa-circle-o"></i>Personal Docente Por Sexo Y Grado Académico Alcanzado</a></li>
                <li><a href="{{url('JefaturaDePersonal/form_001_6')}}"><i class="fa fa-circle-o"></i>Personal Docente Por Categoría Y Dedicación, Según Carreras</a></li>
                <li><a href="{{url('JefaturaDePersonal/form_001_7')}}"><i class="fa fa-circle-o"></i>Personal Administrativo Por Sexo Y Tipo De Contrato</a></li>
                <li><a href="{{url('JefaturaDePersonal/form_001_8')}}"><i class="fa fa-circle-o"></i>Personal Administrativo Por Sexo, Según Actividad</a></li>
                <!--<li><a href="{{url('JefaturaDePersonal/form_001_9')}}"><i class="fa fa-circle-o"></i>Personal Administrativo Por Sexo Según Actividad</a></li>-->
                <!--<li><a href="{{url('JefaturaDePersonal/form_001_10')}}"><i class="fa fa-circle-o"></i>Personal Administrativo Por Sexo Y Ocupación</a></li>-->
                <li><a href="{{url('JefaturaDePersonal/form_001_11')}}"><i class="fa fa-circle-o"></i>Personal Administrativo Según Formación Alcanzada Y Tipo De Contrato</a></li>
                <li><a href="{{url('JefaturaDePersonal/form_001_12')}}"><i class="fa fa-circle-o"></i>Personal Administrativo Según Formación Alcanzada Y Actividad Realizada</a></li>
                <li><a href="{{url('JefaturaDePersonal/form_001_13')}}"><i class="fa fa-circle-o"></i>Personal Administrativo Por Sexo Según Su Formación Alcanzada, Por Repartición Y Actividad Que Realizan</a></li>
                <!--<li><a href="{{url('JefaturaDePersonal/form_001_14')}}"><i class="fa fa-circle-o"></i>Personal Administrativo, Por Sexo Según Su Formación Alcanzada, Por Repartición  Y Actividad Que Realizan </a></li>-->
                <li><a href="{{url('JefaturaDePersonal/form_001_15')}}"><i class="fa fa-circle-o"></i>Personal Administrativo, Según Su Formación Por Tipo De Profesión</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('titulos/form_002_1')}}"><i class="fa fa-circle-o"></i> Profesionales Titulados, Según Facultades</a></li>
                <li><a href="{{url('titulos/form_002_2')}}"><i class="fa fa-circle-o"></i> Profesionales Titulados Por 
                Nivel Académico, Según Facultades</a></li>
                <li><a href="{{url('titulos/form_002_3')}}"><i class="fa fa-circle-o"></i> Profesionales Titulados Por Sexo, Según Carreras</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('DataCenter/form_003_1')}}"><i class="fa fa-circle-o"></i>Matricula Cursos Preuniversitarios, Por Sexo, Según Facultad</a></li>
                <li><a href="{{url('DataCenter/form_003_2')}}"><i class="fa fa-circle-o"></i>Matricula Cursos Preuniversitarios Por Sexo, Según Carreras</a></li>
                <li><a href="{{url('DataCenter/form_003_3')}}"><i class="fa fa-circle-o"></i>Matricula Cursos Preuniversitario Por Carreras, Según Lugar Departamental De Nacimiento</a></li>
                <li><a href="{{url('DataCenter/form_003_4')}}"><i class="fa fa-circle-o"></i>Cursos Preuniversitario Por Tipo De Colegio, Según Carreras y Procedencias</a></li>
                <li><a href="{{url('DataCenter/form_003_5')}}"><i class="fa fa-circle-o"></i>Matricula Preuniversitario, Según Composición De Edad, Por Facultad</a></li>
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('BienestarUniversitario/form_004_1')}}"><i class="fa fa-circle-o"></i>Resumen Total De Becas Alimentacion E Internado Universitario</a></li>
                <li><a href="{{url('BienestarUniversitario/form_004_2')}}"><i class="fa fa-circle-o"></i>Beca Alimentación Por Género, Según Facultades</a></li>
                 <li><a href="{{url('BienestarUniversitario/form_004_3')}}"><i class="fa fa-circle-o"></i>Beneficiarios Con Beca Alimentación, Según Tipo De Beca Por Sexo Y Facultad</a></li>
                <!--<li><a href="ventas/cliente"><i class="fa fa-circle-o"></i>Tasa De Crecimiento De Beca Alimentación</a></li>-->
                 <li><a href="{{url('BienestarUniversitario/form_004_5')}}"><i class="fa fa-circle-o"></i>Beneficiarios Con Beca Alimentación Por Tipo De Beca, Según Sexo Y Carreras</a></li>
                <li><a href="{{url('BienestarUniversitario/form_004_6')}}"><i class="fa fa-circle-o"></i>Beneficiarios Con Beca Internado Universitario, Por Tipo De Beca, Según Facultades</a></li>
                 <li><a href="{{url('BienestarUniversitario/form_004_7')}}"><i class="fa fa-circle-o"></i>Beneficiarios Con Beca Internado Universitario, Por Tipo De Beca, Según Carreras</a></li>
                <li><a href="{{url('BienestarUniversitario/form_004_8')}}"><i class="fa fa-circle-o"></i>Tasa De Crecimiento De Beca Internado</a></li>
                 <li><a href="{{url('BienestarUniversitario/form_004_9')}}"><i class="fa fa-circle-o"></i>Auxiliares De Docencia Según Facultad Y Sexo</a></li>
                <li><a href="{{url('BienestarUniversitario/form_004_10')}}"><i class="fa fa-circle-o"></i>Auxiliares De Docencia Según Carreras Y Tipo De Beca</a></li>
                ...
                <li><a href="{{url('BienestarUniversitario/form_004_14')}}"><i class="fa fa-circle-o"></i>Auxiliares De Investigación  Según Género Y Carreras</a></li>
                ...
                <!--<li><a href="ventas/cliente"><i class="fa fa-circle-o"></i>Tasa De Crecimiento De Beca Auxiliares De Investigación</a></li>-->
                 <li><a href="{{url('BienestarUniversitario/form_004_17')}}"><i class="fa fa-circle-o"></i>Beca Trabajo  Según Género Y Carreras</a></li>
                <!--<li><a href="{{url('BienestarUniversitario/form_004_18')}}"><i class="fa fa-circle-o"></i>Variación Semestral De Beca Trabajo Según Carreras</a></li>-->
   ...
   <!-- <script src="{{asset('js/jquery_v3.3.1.min.js')}}"></script> -->
